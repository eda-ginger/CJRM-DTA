...
cuda_num = 7
cmd_lst = [f"--data ./data/preprocessed/DAVIS/cold_split/Target --d1_type seq --d2_type seq --data_name DAVIS --project_name DeepDTA_CT_BAN --joint bi_att --use_cuda {cuda_num}",
           f"--data ./data/preprocessed/DAVIS/cold_split/Target --d1_type seq --d2_type seq --data_name DAVIS --project_name DeepDTA_CT_MHA-Co --joint co_att --use_cuda {cuda_num}",
           f"--data ./data/preprocessed/DAVIS/cold_split/Target --d1_type seq --d2_type seq --data_name DAVIS --project_name DeepDTA_CT_MHA-Cross --joint cross_att --use_cuda {cuda_num}",
...
for command in cmd_lst:
    ...
    finish(f'\nFinished: {command}\nLearning time: {f_time} - server 22-7')
