...
## multiple
# # SnS, SnG
cmd_lst = ['--data ./data/preprocessed/DAVIS/cold_split/Drug_and_Target --d1_type graph --d2_type seq --data_name DAVIS --project_name DAVIS_cold_DT_GnS_ban --joint bi_att --virtual_node --n_workers 4 --batch_size 512',
