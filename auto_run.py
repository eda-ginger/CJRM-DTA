...
## multiple
# # SnS, SnG
cmd_lst = ['--data ./data/preprocessed/KIBA/random --d1_type seq --d2_type seq --data_name KIBA --project_name KIBA_random_SnS_mgt --joint joint_att --n_workers 10 --batch_size 512',
